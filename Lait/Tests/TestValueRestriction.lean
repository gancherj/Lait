...
/--
error: The body of r can not be generalized here. Give r a type annotation that does not use type variables.
-/
#guard_msgs in
{lait_decl vrAlloc
  #include stdlib
...
/--
error: The body of xs can not be generalized here. Give xs a type annotation that does not use type variables.
-/
#guard_msgs in
{lait_decl vrApp
  #include stdlib
...
/--
error: The body of shadowed can not be generalized here. Give shadowed a type annotation that does not use type variables.
-/
#guard_msgs in
